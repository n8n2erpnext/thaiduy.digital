...
const frameSchema = z.object({
  ...
  tempoReliable: z.boolean().optional(),
  tempoSource: z.enum(['autocorr','onset','blend','unknown']).optional(),
  tempoAutocorrConfidence: unit.optional(),
  tempoOnsetConfidence: unit.optional(),
  processIntervalMs: z.number().finite().min(0).max(1_000).optional(),
  beatConfidence: unit.optional(),
  meter: z.enum(['2/4','3/4','4/4','6/8','12/8','unknown']).optional(),
