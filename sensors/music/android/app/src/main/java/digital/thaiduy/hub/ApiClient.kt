...
object ApiClient {
    ...
    fun sendFrame(
        ...
        val payload = JSONObject()
            ...
            .put("tempoAutocorrBpm", features.tempoAutocorrBpm)
            .put("tempoOnsetBpm", features.tempoOnsetBpm)
            .put("tempoReliable", features.tempoReliable)
            .put("tempoSource", features.tempoSource)
            .put("tempoAutocorrConfidence", features.tempoAutocorrConfidence)
            .put("tempoOnsetConfidence", features.tempoOnsetConfidence)
            .put("processIntervalMs", features.processIntervalMs)
            .put("beatConfidence", features.beatConfidence)
            .put("meter", features.meter)
            .put("meterCorr2", features.meterCorr2)
            .put("meterCorr3", features.meterCorr3)
            .put("meterCorr4", features.meterCorr4)
            .put("meterAccent2", features.meterAccent2)
            ...
            .put("meterOppositeAsymmetry4", features.meterOppositeAsymmetry4)
